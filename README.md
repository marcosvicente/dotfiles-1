...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/marcosvicente/dotfiles-1/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/marcosvicente/dotfiles-1/master/install.sh`" -s ask
```
